...
async function loadAllCommandes() {
  ...
  try {
    ...
    const url = `${API_BASE_URL}/api/commandes${params.toString() ? `?${params.toString()}` : ""}`;
...
async function loadAvisModeration() {
  ...
  try {
    const response = await fetch(`${API_BASE_URL}/api/avis/moderation?statut=en_attente`, {
      headers: {
        "X-AUTH-TOKEN": token
      }
    });
...
async function updateStatus(id, statut) {
  ...
  try {
    const response = await fetch(`${API_BASE_URL}/api/commandes/employe/${id}/status`, {
      method: "PATCH",
      headers: {
...
async function cancelCommande(id) {
  ...
  try {
    const response = await fetch(`${API_BASE_URL}/api/commandes/employe/${id}/cancel`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        "X-AUTH-TOKEN": token
...
async function validateAvis(id) {
  ...
  try {
    const response = await fetch(`${API_BASE_URL}/api/avis/${id}/validate`, {
      method: "PATCH",
      headers: {
        "X-AUTH-TOKEN": token
      }
...
async function rejectAvis(id) {
  ...
  try {
    const response = await fetch(`${API_BASE_URL}/api/avis/${id}/reject`, {
      method: "PATCH",
      headers: {
        "X-AUTH-TOKEN": token
      }
